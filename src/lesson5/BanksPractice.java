...
public class BanksPractice {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(findClientsWithNegtiveBalance(names, balances)));
    ...
    static String[] findClientsWithNegtiveBalance(String[] clients, int[] balances) {
        //String[] results = new String[clients.length];
